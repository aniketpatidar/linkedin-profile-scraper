/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e2e187fdc1da2ec39f833a0561d80f26)
// Runtime types generated with workerd@1.20260825.1 2026-08-26 nodejs_compat
interface __BaseEnv_Env {
	LINKEDIN_SESSION_COOKIE: string;
	SESSION_COORDINATOR: DurableObjectNamespace<import("./src/index").ProfileSessionCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ProfileSessionCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LINKEDIN_SESSION_COOKIE">> {}
}
